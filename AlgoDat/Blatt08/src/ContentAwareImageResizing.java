...
public class ContentAwareImageResizing {
    ...
    public int[] leastContrastImageVPath() {
        // TODO
        WeightedDigraph g = makeVGraph();
        ShortestPathsTopological gtp = new ShortestPathsTopological(g,sx*sy);
        Stack<Integer> way = gtp.pathTo(sx*sy+1);
        int[] result = new int[way.size()-2] ;
        int i = 0;
        way.remove(0);
